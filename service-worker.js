const CACHE_NAME = 'cache-v57'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v57',
    'estilos/styles.css?v57',
    'estilos/mediaQueries.css?v57',
    'javascript/script.js?v57',
